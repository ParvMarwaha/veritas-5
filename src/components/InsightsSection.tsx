  ...
  return (
    <section className="relative w-full bg-[#111] text-white py-20 md:py-28 overflow-hidden border-t border-white/5">
      ...
      >
        ...
        {/* View All Action */}
        <motion.div variants={itemVariants} className="mt-12 flex justify-center w-full">
          <AnimatedButton variant="text" className="border border-white/20 px-10 py-5 whitespace-nowrap">
            View All Insights
          </AnimatedButton>
        </motion.div>
